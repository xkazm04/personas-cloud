...
export class Connection {
  ...
  connect(): void {
    ...
    // Connect without token in URL — auth is sent in the hello message to
    // avoid exposing the token in proxy/CDN/load-balancer access logs.
  ...
  sendProgress(executionId: string, progress: import('@dac-cloud/shared').ExecutionProgress): void {
    this.send({
      type: 'progress',
      executionId,
